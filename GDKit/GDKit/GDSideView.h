...
@protocol GDSideViewDelegate <NSObject>
...
@interface GDSideView : UIView

@property (strong,nonatomic)id<GDSideViewDelegate>delegate;
@property (assign,nonatomic)BOOL isOpen;
@property (strong,nonatomic)UIButton *grayView;
@property (strong,nonatomic)UIView *leftSideView;

-(instancetype)initWithDelegate:(id<GDSideViewDelegate>)theDelegate frame:(CGRect)frame;//注意不要被覆盖在其它视图下面
